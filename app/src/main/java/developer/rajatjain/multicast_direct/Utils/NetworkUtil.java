package developer.rajatjain.multicast_direct.Utils;
...
public class NetworkUtil {
    ...
    private static final String NETWORK_INTERFACE_NAME = "p2p0";
    private static final String ALTERNATE_NETWORK_INTERFACE_NAME = "p2p0";
